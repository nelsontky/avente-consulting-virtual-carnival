...
export default class MainScene extends Phaser.Scene {
  ...
  async openIntro() {
    ...
    await new Dialog(
      this,
      {
        content: `Welcome to Avente Consulting's Welfare Day Game!\n\nTo redeem your welfare pack, visit all 5 stations and talk to all 13 members from our Avente Exco! Be amongst the first 250 students to join AND complete the game to claim your welfare goodies! Let's begin!`,
        choices: nextButtonOnlyChoices,
      },
      false
    ).create();
